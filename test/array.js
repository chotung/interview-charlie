describe('Array', function () {
  ...
  describe('#findIndex()', function () {
    ...
    it("should return a TypeError: cannot read properties of null (reading 'find')", function () {
      expect(() => {
        Array.prototype.findIndex.call(null, x => true)
      }).to.throw(TypeError, "Cannot read properties of null (reading 'findIndex')")
    })

    it("should return a  TypeError: undefined is not a function", function () {
      expect(() => [1, 2, 3].findIndex()).to.throw(TypeError, "undefined is not a function")
      expect(() => [1, 2, 3].findIndex("not a fn")).to.throw(TypeError, "undefined is not a function")
      expect(() => [1, 2, 3].findIndex(null)).to.throw(TypeError, "undefined is not a function")
      expect(() => [1, 2, 3].findIndex({})).to.throw(TypeError, "undefined is not a function")
    })
  })
  ...
  describe('#includes()', function () {
    ...
    it("should return a TypeError: cannot read properties of null (reading 'includes')", function () {
      expect(() => {
        Array.prototype.includes.call(null, x => true)
